        ...
        <div style={{ fontFamily: 'system-ui, -apple-system, sans-serif', backgroundColor: '#f9fafb', minHeight: '100vh', padding: '24px 20px', boxSizing: 'border-box' }}>
            ...
            <div style={{ maxWidth: '1080px', margin: '0 auto' }}>
                ...
                <nav style={{ display: 'flex', gap: '8px', marginBottom: '20px', backgroundColor: '#ffffff', border: '1px solid #e5e7eb', borderRadius: '10px', padding: '6px', boxShadow: '0 2px 4px rgba(0,0,0,0.04)' }}>
                    {(['first-scan', 'second-scan', 'damaged-barcode', 'verify', 'config', 'reports'] as const)
                        ...
                        .map((tab) => (
                            <button
                                ...
                                style={{
                                    ...
                                    color: activeTab === tab ? '#e21b22' : '#6b7280',
                                    border: 'none',
                                    borderBottom: activeTab === tab ? '3px solid #e21b22' : '3px solid transparent',
                                    borderRadius: '6px',
                                    cursor: 'pointer',
                                    fontSize: '13px',
                            ...
                            >
                                {tab === 'first-scan' 
                                    ? '1st Scan: Box Unsealing' 
                                    : tab === 'second-scan' 
                                    ? '2nd Scan: LMD Verification' 
                                    : tab === 'damaged-barcode' 
                                    ? 'Damaged Skynet (Temu Scan)' 
                                    : tab === 'verify' 
                                    ? 'Dispatch verify' 
                                    : tab === 'config' 
                                    ? 'Zone config' 
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '16px' }}>
                            ...
                            <div style={card}>
                                ...
                                {rowItem('Scanned today', <span style={{ color: '#e21b22', fontWeight: '700' }}>{scannedToday}</span>, true)}
                                {damagedCurrentScan && damagedStatus === 'SUCCESS' && (
                                    <div style={{ marginTop: '12px', fontSize: '11px', color: '#16a34a', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '4px' }}>
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ verticalAlign: 'middle' }}>
                                            <polyline points="20 6 9 17 4 12" />
                                        </svg>
                                ...
                                {damagedCurrentScan?.assignedPartner ? (
                                    <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
                                        ...
                                        <div style={{
                                            ...
                                            <span style={{ fontSize: '11px', color: '#6b7280', fontWeight: 'bold', textTransform: 'uppercase' }}>Resolved Skynet Tracking Number</span>
                                            <span style={{ fontSize: '22px', fontWeight: '800', fontFamily: 'monospace', letterSpacing: '1px', color: '#dc2626' }}>
